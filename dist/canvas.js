    ...
    _createClass(DrawGraph, [{
        ...
        value: function DrawCircleGraph(data, legendText) {
            ...
            for (var _i = 0; _i < data.length; _i++) {
                ...
                // 次データのスタート位置調整
                startAng = startAng + 2 * Math.PI * (data[_i][1] / dataSum);
            }
        ...
        key: 'DrawLine',
        value: function DrawLine(x1, y1, x2, y2, lineWidth, lineColor, lineDashFlg) {
        ...
        key: 'DrawFillCircle',
        value: function DrawFillCircle(x, y, rad, fillColor, flg) {
        ...
        key: 'DrawFillFan',
        value: function DrawFillFan(x, y, rad, startAng, endAng, fillColor) {
            fillColor = typeof fillColor !== 'undefined' ? fillColor : this.fillColor;
        ...
        key: 'DrawFillBox',
        value: function DrawFillBox(x, y, width, height, fillColor, lineColor, flg) {
            fillColor = typeof fillColor !== 'undefined' ? fillColor : this.fillColor;
            lineColor = typeof lineColor !== 'undefined' ? lineColor : this.lineColor;
            flg = typeof flg !== 'undefined' ? flg : true;
            if (!flg) {
        ...
        key: 'DrawBox',
        value: function DrawBox(x, y, width, height, lineColor, flg) {
            lineColor = typeof lineColor !== 'undefined' ? lineColor : this.lineColor;
            flg = typeof flg !== 'undefined' ? flg : true;
            if (!flg) {
                height = height * -1;
        ...
        key: 'DrawFillText',
        value: function DrawFillText(x, y, text, textAlign, maxLength, textColor, textFont) {
        ...
        key: 'CreateAxis',
        value: function CreateAxis(axisColor, opX, opY, maxX, maxY, unitX, unitY, yCount, unitXText, unitYText) {
            // 描画色の設定
            ...
            if (yCount.minus > 0) {
                ...
                tmpY = opY - unitY;
                // 縦軸単位線（マイナス方向）
                for (var i = yCount.minus - 1; i > 0; i--) {
                    // 基準点描画
            ...
            // 縦軸単位線（プラス方向）
            for (var _i2 = 1; _i2 <= yCount.plus - 1; _i2++) {
                // 基準点描画
                this.DrawLine(opX - 3, Math.round(tmpY), opX + 3, Math.round(tmpY), 1, axisColor);
                // 基準単位描画
        ...
        key: 'CreateLegend',
        value: function CreateLegend(legendText, fillColor) {
        ...
        key: 'CreateTitle',
        value: function CreateTitle(title, position) {
        ...
        value: function dataProcessing(data) {
            ...
            for (var _i3 = 0; _i3 < this.data.xCount; _i3++) {
                for (var _j = 1; _j < this.data.drawDataCount + 1; _j++) {
                    // Y軸最小値の再計算
            ...
            if (this.data.maxYdata - this.data.minYdata > this.axis.unitY * 10 && this.axis.autoVerticalScaleAdjust) {
                // 縦軸目盛自動調整
                this.axis.unitY = Math.pow(10, String(this.data.maxYdata - this.data.minYdata).length - 1);
            }
